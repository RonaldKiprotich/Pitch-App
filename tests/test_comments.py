...
class CommentModelTest(unittest.TestCase):
    def setUp(self):
        self.user_Dorcas = User(username = 'Ray254',password = '1234', email = 'raytwit660@gmail.com')
        self.new_pitch = Pitch(id=1,pitch_title='Pickup',pitch_comment='yoh men',category="interview",user = self.user_Ray254,likes=0,dislikes=0)
